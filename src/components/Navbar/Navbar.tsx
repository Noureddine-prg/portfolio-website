        ...
        >
            <div className="container mx-auto flex justify-between items-center ">
                ...
                <ul className="flex text-3xl space-x-6 font-semibold">
                    <li><a href="/" className="hover:text-gray-400 transition duration-500">Home</a></li>
                    <li><a href="/about" className="hover:text-gray-400 transition duration-500">About</a></li>
                    <li><a href="/portfolio" className="hover:text-gray-400 transition duration-500">Portfolio</a></li>
                    <li><a href="/contact" className="hover:text-gray-400 transition duration-500">Contact</a></li>
                </ul>
            </div>
      </motion.div>
    );
