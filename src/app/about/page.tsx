...
export default function About() {
  ...
  return (
    ...
    {/* Left Side */}
      <motion.div className="w-full md:w-1/2 h-full flex flex-col" variants={fadeIn}>
      ...
      {/* Right Side */}
      <motion.div className="w-full md:w-1/2 flex flex-col items-center md:items-end" variants={fadeIn}>
